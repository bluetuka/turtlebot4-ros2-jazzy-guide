...
ARGUMENTS = [
    ...
    DeclareLaunchArgument('world', default_value='maze_class7',
...
_POSE_DEFAULTS = {'x': '-8.0', 'y': '8.0', 'z': '0.0', 'yaw': '0.0'}
for pose_element in ['x', 'y', 'z', 'yaw']:
    ARGUMENTS.append(DeclareLaunchArgument(pose_element, default_value=_POSE_DEFAULTS[pose_element],
